...
<div class="vip_reg_main_wrap am-vertical-align">
    <div class="am-vertical-align-middle">
        <div class="vip_reg_main">
           <form class="form-horizontal row J_ajax_form" role="form" method="post" action="/dic/edit">
			<h2>
				会员分类编辑
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input name="dicGroup" value="${dic.dicGroup}" readonly="readonly" id="realname" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="dicName" value="${dic.dicName}" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="dicKey" value="${dic.dicKey}" id="realname" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                    </div>                    
