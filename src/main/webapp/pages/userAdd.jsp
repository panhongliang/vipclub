...
<div class="vip_reg_main_wrap am-vertical-align">
    <div class="am-vertical-align-middle">
        <div class="vip_reg_main">
           <form class="form-horizontal row J_ajax_form" role="form" method="post" action="/user/add">
			<h2>
				添加管理员
            ...
            <div class="vip_reg_main_part_2">
                    <div class="row ">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="realname" class="col-sm-3 control-label">管理员帐号</label>
                                <div class="col-sm-9">
                                    <input name="account" id="realname" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="sex" class="col-sm-3 control-label">姓名</label>
                                <div class="col-sm-9">
                    ...
                    <div class="row ">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="realname" class="col-sm-3 control-label">密码</label>
                                <div class="col-sm-9">
                                    <input name="password" id="realname" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                    </div>                    
                    <div class="row submit">
                        ...
                        <div class="col-sm-3 col-end">
                            <button type="button" class="button button-pill button-primary btn-cancel button-small" onclick="window.location.href='/user/toList'">取消</button>
                        </div>
                    </div>                    
            </div>
            </form>
