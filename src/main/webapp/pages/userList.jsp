   ...
   <div class="am-vertical-align-middle">
       <div class="vip_serach_main">
        <h2>
            ...
            <button class="button button-pill button-primary button-tiny" onclick="window.location.href='/user/toAdd'">添加</button>
        </h2>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        data-id="${user.id}"><i class="am-icon-edit"></i> 删除</button>
                     </td>
                </tr>
                </c:forEach>
            </tbody>
